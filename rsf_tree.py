...
rsf = RandomSurvivalForest(n_estimators= 150,min_samples_split= 10,
                                           min_samples_leaf= 10,
                                           max_features= None,
                                           n_jobs=-1,
                                           random_state= None)
...
plt.title('RSF model estimate of survival for 6 test individuals')
plt.legend()
plt.grid(True)
plt.show()
plt.savefig('rsfsurvfunctest.png')
